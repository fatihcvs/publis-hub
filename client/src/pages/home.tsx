                    ...
                    >
                      <div className="flex items-center justify-between gap-4">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <code className="text-lg font-mono font-bold text-primary" data-testid={`text-discount-code-${code.id}`}>
                              {code.code}
                            </code>
                            {code.discountPercent !== null && code.discountPercent !== undefined && (
                      ...
                      {code.description && (
                        <p className="text-sm text-muted-foreground mt-3 pl-12 leading-relaxed">
                          {code.description}
                        </p>
                      )}
